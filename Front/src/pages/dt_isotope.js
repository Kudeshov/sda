  ...
  useEffect(() => {
    setEditStarted((valueTitleInitial!==valueTitle)||(valueNameRusInitial!==valueNIndex)||(valueHalfLifeValueInitial!==valueHalfLifeValue)
      ||(valueHalfLifePeriodInitial!==valueHalfLifePeriod)||(valueDecayConstInitial!==valueDecayConst)||(valueNuclideIdInitial!==valueNuclideId));
        ...
        valueHalfLifePeriodInitial, valueHalfLifePeriod, valueDecayConstInitial, valueDecayConst,valueNuclideId]); 
    ...
    <tr>
      ...
      <FormControl sx={{ width: '60ch' }} size="small">
        <InputLabel id="fiz">Радиоизотоп</InputLabel>
          <Select labelId="fiz" id="fiz1" label="Радиоизотоп" defaultValue="" value={valueNuclideId||"0"} onChange={e => setValueNuclideId(e.target.value)}>
  ...
  <Dialog open={openSave} onClose={handleCloseSaveNo} fullWidth={true}>
    ...
    <DialogContent>
        <DialogContentText>
            ...
            {valueNuclideId === valueNuclideIdInitial ? '' : 'Комментарий (англ. яз): '+valueNuclideId+'; ' }<p/>
